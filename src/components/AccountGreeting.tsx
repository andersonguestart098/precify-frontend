...
export default function AccountGreeting() {
  ...
  return (<Stack direction="row" gap={{ xs: 2.25, md: 1.8, xl: 2.25 }} alignItems="center" mb={{ xs: 3, md: 2.25, xl: 3.5 }}>
      ...
      <Box>
        <Typography sx={{ fontSize: { xs: 15, md: 15, xl: 16 }, lineHeight: 1.3 }}>Olá,</Typography>
        <Typography sx={{ fontSize: { xs: 18, md: 18, xl: 20 }, lineHeight: 1.25, fontWeight: 850 }} color="primary.dark">{user.name}!</Typography>
      </Box>
    </Stack>);
}
